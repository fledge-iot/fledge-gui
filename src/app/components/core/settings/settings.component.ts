...
export class SettingsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.checkUpdateTime = (localStorage.getItem('UPDATE_CHECK_INTERVAL') != null && +localStorage.getItem('UPDATE_CHECK_INTERVAL') > 3600000) ? localStorage.getItem('UPDATE_CHECK_INTERVAL') : '604800000';
