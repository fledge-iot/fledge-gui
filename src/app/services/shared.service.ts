...
export class SharedService {
  ...
  public checkUpdateInterval: BehaviorSubject<any> = new BehaviorSubject<any>(localStorage.getItem('UPDATE_CHECK_INTERVAL') != null && (+localStorage.getItem('UPDATE_CHECK_INTERVAL') > 3600000 || localStorage.getItem('UPDATE_CHECK_INTERVAL') === '-1') ?
