...
export class SharedService {
  ...
  public checkUpdateInterval: BehaviorSubject<any> = new BehaviorSubject<any>(localStorage.getItem('OPTED_UPDATE_INTERVAL') != null ?
    localStorage.getItem('OPTED_UPDATE_INTERVAL') : '604800000');
